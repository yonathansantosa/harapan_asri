              ...
              <table id="table-data" class="min-w-full">
                <thead class="bg-gray-50">
                  <tr class="text-base uppercase leading-normal text-black">
                    ...
                    <th class="py-3 px-6 text-left font-semibold">Posisi</th>
                ...
                <tbody class="bg-white text-base font-light text-gray-700">
                  ...
                  @foreach ($user as $u)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                      ...
                      <td class="whitespace-nowrap py-3 px-6 text-left">
                        <div class="flex items-center">
                          <span class="font-semibold">{!! $u->status == 1 ? '<span class="bg-green-200 text-green-700 font-semibold py-1 px-3 rounded-full text-sm">Aktif</span>' : '<span class="bg-red-200 text-red-700 font-semibold py-1 px-3 rounded-full text-sm">Non-Aktif</span>' !!}</span>
                        </div>
                      </td>
                      <td class="whitespace-nowrap py-3 px-6 text-left">
                        <div class="flex items-center">
                          <span class="font-semibold">{{ $role[$u->id_level - 1]->keterangan }}</span>
                        </div>
                      </td>
