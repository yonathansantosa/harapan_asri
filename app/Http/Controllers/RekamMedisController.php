...
class RekamMedisController extends Controller
{
  ...
  public function data_penghuni(Request $request)
  {
    ...
    if (empty($request->input('search.value'))) {
      $penghuni = Penghuni::daftar_penghuni('', $start, $limit, $order, $dir);
    } else {
      $search = $request->input('search.value');
      $penghuni = Penghuni::daftar_penghuni($search, $start, $limit, $order, $dir);
    }
    $data = array();
  ...
  public function detail_medis_table(Request $request, $tb)
  {
    ...
    $db_data = RekamMedis::get_detail_medis_data($table_name, $id_penghuni, $search, $start, $limit, $order, $dir, $startDate, $endDate);
    $totalData = RekamMedis::count_detail_medis_data($table_name, $id_penghuni, $search, $startDate, $endDate);
