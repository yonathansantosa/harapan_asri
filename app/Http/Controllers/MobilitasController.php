...
class MobilitasController extends Controller
{
  ...
  {
    // $data['mobilitas'] = Mobilitas::daftar_mobilitas();
  ...
  public function dataMobilitas(Request $request)
  {
    ...
    if (empty($request->input('search.value'))) {
      $mobilitas = Mobilitas::daftar_mobilitas('', $start, $limit, $order, $dir);
    } else {
      $search = $request->input('search.value');
      $mobilitas = Mobilitas::daftar_mobilitas($search, $start, $limit, $order, $dir);
  ...
  public function prosesEditMobilitas(Request $request)
  {
    ...
    Mobilitas::mobilitas_edit($id, $id_penghuni, $tujuan, $keluar, $petugas_keluar, $kembali, $petugas_kembali);
  ...
  public function detailMobilitas(Request $request)
  {
    ...
    $data['mobilitas'] = Mobilitas::detail_mobilitas($id);
    $data['penghuni'] = Penghuni::detail_penghuni($data['mobilitas']->id_penghuni);
