...
class PegawaiController extends Controller
{
  ...
  public function prosesTambahPegawai(Request $request)
  {
    ...
    $error_tambah = User::tambah($request);
  ...
  {
    // return view('pegawai.ubahpassword')->with(['data' => User::get_ganti_password($id)]);
  }
  ...
  public function prosesUbahPassword(Request $request)
  {
    ...
    // $error_ubahpassword = User::ganti_password($request);
  }
  ...
  public function prosesUbahPassword1(Request $request)
  {
    ...
    //   $username = ['username' => User::get_ganti_password()];
    //   $request->flash();
  ...
  public function prosesUbahPegawai(Request $request)
  {
    ...
    $request['pelatihan'] = $request->pelatihan ?? null;

    $data = $request->except(['_token']);
    $data['foto'] = $imagename;

    $error_update = User::edit($data);
  ...
  public function getEdit(Request $request)
  {
    $return =  [
      'role' => Role_user::get_role(),
      'user' => User::get_user_detail($request->id)
    ];
    return $return;
  }
